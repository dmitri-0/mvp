...
class ThemeManager:
    ...
    # SVG-иконки для темной темы (белые тонкие стрелки/галочки)
    # Стрелка вправо (для закрытой ветки) - стиль Windows "chevron"
    # <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><path d="M6 4L10 8L6 12" fill="none" stroke="#ffffff" stroke-width="1.5"/></svg>
    ICON_CLOSED_B64 = "data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMTYiIGhlaWdodD0iMTYiIHZpZXdCb3g9IjAgMCAxNiAxNiIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj48cGF0aCBkPSJNNiA0TDEwIDhMNiAxMiIgZmlsbD0ibm9uZSIgc3Ryb2tlPSIjZmZmZmZmIiBzdHJva2Utd2lkdGg9IjEuNSIvPjwvc3ZnPg=="
    
    # Стрелка вниз (для открытой ветки) - стиль Windows "chevron"
    # <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><path d="M4 6L8 10L12 6" fill="none" stroke="#ffffff" stroke-width="1.5"/></svg>
    ICON_OPEN_B64 = "data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMTYiIGhlaWdodD0iMTYiIHZpZXdCb3g9IjAgMCAxNiAxNiIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj48cGF0aCBkPSJNNCA2TDggMTBMMTIgNiIgZmlsbD0ibm9uZSIgc3Ryb2tlPSIjZmZmZmZmIiBzdHJva2Utd2lkdGg9IjEuNSIvPjwvc3ZnPg=="
    ...
    /* Стилизация индикаторов ветвления (стрелок) */
    ...
    def apply_theme(theme_name: str):
        ...
        if theme_name == "dark":
            ...
            # Применяем полную таблицу стилей с кастомными иконками
            stylesheet = ThemeManager.DARK_STYLESHEET_TEMPLATE.format(
                branch_closed_icon=ThemeManager.ICON_CLOSED_B64,
                branch_open_icon=ThemeManager.ICON_OPEN_B64
            )
