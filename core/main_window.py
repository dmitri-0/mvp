...
from PySide6.QtGui import QFont, QTextDocument, QKeySequence, QShortcut
from PySide6.QtWidgets import (
    QMainWindow, QTreeWidget, QTreeWidgetItem, QSplitter, 
...
class SettingsDialog(QDialog):
    ...
    def save_settings(self):
        ...
        QMessageBox.information(self, "Настройки", "Настройки сохранены. Перезапустите приложение для применения изменений.")
        self.accept()
